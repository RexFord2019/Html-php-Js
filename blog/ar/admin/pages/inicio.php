     ...
     <div class="row">
            ...
            <?php
               ...
               '<div class="alert alert-info">
                      ...
                      <strong>Olá, '.$nomeLogado.'!</strong> Seja Bem vindo ao <strong>DL. Blog</strong> !
               </div>';
					}
				}
			 ?>  
            ...
            <div class="span12">	      		
	      		<div id="target-1" class="widget">	      			
	      			<div class="widget-content">	      				
			      		<h1>Douglas P. Lacerda - Apresentação</h1>			      		
			      		<p>O <strong>Meu Blog</strong> é baseado em ciências e Religião'<strong>Tudo que tem fundamento científico e ou religioso</strong>', aqui tenho objetivo é gerenciar toda parte de postagens e
                        algumas funções internas do próprio sistema.	<br>
                        O Sistema foi desenvolvido na linguagem <strong>PHP. 7</strong>, utilizando juntamente com a classe <strong>PDO</strong>. O banco de dados utilizado é o famoso <strong>MySQL</strong>.</p>
                        ...
                        <p><strong>Forte abraço, Vamo publicar tudo que é fato!</strong></p>
